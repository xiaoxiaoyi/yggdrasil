...
#include "../exceptions/BitcountOutOfRange.hpp"
#include "../exceptions/BitIndexOutOfBounds.hpp"
...
namespace ygg
{
	...
	public:
        ...
        size_t operator() (const ygg::Bitset<bitcount>& t) const;
        bool operator() (const ygg::Bitset<bitcount>& one, const ygg::Bitset<bitcount>& two) const;
	};

	template <int bitcount>
    size_t BitsetHash<bitcount>::operator() (const ygg::Bitset<bitcount>& t) const
	{
		size_t total = 0;
	...
	template <int bitcount>
    bool BitsetHash<bitcount>::operator() (const ygg::Bitset<bitcount>& one, const ygg::Bitset<bitcount>& two) const
	{
		return one == two;
	}
};
